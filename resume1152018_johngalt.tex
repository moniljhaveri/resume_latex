...
\makebox[\linewidth]{\rule{17cm}{0.4pt}}
\begin{itemize}
	\item \textit{Advanced Data Structures}
	\item \textit{Embedded Systems}
	\item \textit{High Performance Computing}
	\item \textit{Web Development}
	\item \textit{Deep Learning}
	\item \textit{Data Science in Python}
	\item \textit{Learning from Data}
	\item \textit{Digital Image Processing}
\end{itemize}
